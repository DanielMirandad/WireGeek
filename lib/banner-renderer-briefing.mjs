...
export function normalizeBanner(
    ...
    if (shortWords.length > 2) {
        throw inputError(
            "titulo_curto deve possuir no maximo duas palavras.",
...
async function measureShortTitle(
    ...
    if (
        ...
        throw inputError(
            "titulo_curto deve possuir uma ou duas palavras.",
            "SHORT_TITLE_TOO_LONG"
        );
    }

    /*
     * Fonte permanece exatamente em 100 px.
     */
    const regular =
        await raster(
            text,
    ...
    if (
        ...
        throw inputError(
            "SHORT_TITLE_TOO_LONG: titulo_curto nao cabe em 100px.",
            "SHORT_TITLE_TOO_LONG"
        );
    }
