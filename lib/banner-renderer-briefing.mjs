        ...
        await Promise.all(
            editorialLines.map(
                async line => {
                     ...
                     * line-height 52 px
                     *
                     * Sharp/Pango pode produzir diferenca
                     * de 1 ou 2 px na caixa raster entre
                     * Windows e Linux.
                     *
                     * Essa tolerancia nao altera o avanco
                     * vertical das linhas.
                     */
                    const rasterHeightTolerance = 2;

                    if (
                        trimmed.info.height >
                        editorial.lineHeight + rasterHeightTolerance
                    ) {
                        throw inputError(
                            "COPY_TOO_LONG: raster editorial excede a tolerancia segura.",
                            "COPY_TOO_LONG"
                        );
                    }
                    return trimmed;
